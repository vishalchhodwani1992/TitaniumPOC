...
(function(service) {
	...
	var serviceIntent = service.getIntent(),
	    title = serviceIntent.hasExtra('title') ? serviceIntent.getStringExtra('title') : 'Gongcha POS',
	    message = serviceIntent.hasExtra('message') ? serviceIntent.getStringExtra('message') : '',
	    notification_type = serviceIntent.hasExtra('notification_type') ? serviceIntent.getStringExtra('notification_type') : '',
	...
	// launcherIntent.putExtra("flag", flag);
